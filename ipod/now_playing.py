...
class PantallaNowPlaying:
    ...
    def dibujar(self, pantalla, estado_play):
        ...
        if self.cover_surf:
            ...
            # Cuadrado vacio si no hay caratula
            pygame.draw.rect(pantalla, GRIS_PIXEL, (10, 50, 140, 140), 1)
        
        # 2. Textos (Derecha)
        def cut(t): return t[:14]+".." if len(t)>14 else t
        
        pantalla.blit(self.font_big.render(cut(self.track), ANTIALIASING, VERDE_SPOTIFY), (160, 60))
        pantalla.blit(self.font_small.render(cut(self.artist), ANTIALIASING, VERDE_SPOTIFY), (160, 90))
